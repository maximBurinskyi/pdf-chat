...
//           seconds
//         </h1>
//         <p className="mt-5 max-w-prose text-zink-700 sm:text-lg">
//           Program allows you to have conversations with any pdf documents.
...
//             <div className="flex flex-col space-y-2 border-l-4 border-zink-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
  ...
  return (
    <>
      <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
        ...
        <h1 className="max-w-4xl text-5xl font-bold md:text-6xl lg:text-7xl">
          PDF AI analytis via chat with your{' '}
